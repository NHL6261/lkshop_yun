  ...
  <div id="app">
    <div
      ...
      :class="[
        fun.getPhoneEnv() == 3 &&
        !fun.isApp() &&
        (!$route.meta.isPC || ($store.state.caseLibrary != null && $store.state.caseLibrary.set.pc_style == 0))
          ? 'pcStyle'
          : ''
      ]"
      :style="{
    ...
    <div id="returnLiveBtn" v-if="isShowReturnLiveBtn" @click.stop="gotoLiveRoom">
      ...
      ><span class="rlbtext"
        >返回直播<i class="iconfont icon-adsystem_icon_cancle clone_btn_style" @click.stop="clearLiveBtn"></i
      ></span>
    </div>
    <!-- 返回直播按钮end -->
