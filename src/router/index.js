...
// 新增商城首页跳转路由
const Index = r => require(['../views/index/index1.vue'], r)
const enterprise = r => require(['../views/classification/enterprise'], r)
const classificationShop = r => require(['../views/classification/shop'], r)
const classificationPeople = r => require(['../views/classification/people'], r)
    //新增列表页 2021/4/7
const listEnterprise = r => require(['../views/listPage/enterprise'], r)
...
const findDetail = r => require(['../views/find/findDetail'], r)
const FindAdd = r => require(['../views/find/findAdd'], r)
    //新增消息
const news = r => require(['../views/news/news'], r)

// 牛人
const StrongMan = r => require(['../views/member/strongMan/strongMan'], r)
const StrongManInfo = r => require(['../views/member/strongMan/strongManInfo'], r)
const StrongManInfoNew = r => require(['../views/member/strongMan/strongManInfoNew'], r)
    // 企业
const Enterprise = r => require(['../views/member/enterprise1/enterprise'], r)
const EnterpriseInfo = r => require(['../views/member/enterprise1/enterpriseInfo'], r)
    // 审核三种状态
const EnterpriseInfoSubmitSuccess = r => require(['../views/member/enterprise1/enterpriseInfoSubmitSuccess'], r)
const EnterpriseExamimg = r => require(['../views/member/enterprise1/enterpriseExamimg'], r)
const EnterpriseInfoExamFaild = r => require(['../views/member/enterprise1/enterpriseInfoExamFaild'], r)



// 认证成功
const validSuccess = r => require(['../views/member/enterprise1/validSuccess'], r)
    // 认证失败
const validFaild = r => require(['../views/member/enterprise1/validFaild'], r)

// 企业推广红包
const RedPackets = r => require(['../views/member/enterprise1/redPackets'], r)
const PaySuccess = r => require(['../views/member/enterprise1/paySuccess'], r)
const queryResults = r => require(['../views/member/enterprise1/queryResults'], r)
const PromotionRecord = r => require(['../views/member/enterprise1/promotionRecord'], r)
const CollectionDetails = r => require(['../views/member/enterprise1/collectionDetails'], r)
    // 商铺
const Shops = r => require(['../views/member/shops/shops'], r)
const ShopsInfo = r => require(['../views/member/shops/shopsInfo'], r)



// 动态
const DynamicList = r => require(['../views/member/dynamic/dynamicList'], r)
const DynamicInfo = r => require(['../views/member/dynamic/dynamicInfo'], r)
const DynamicPreview = r => require(['../views/member/dynamic/dynamicPreview'], r)
const DynamicPubSuccess = r => require(['../views/member/dynamic/dynamicPubSuccess'], r)
    // 企业管理
const StrongManManage = r => require(['../views/member/strongMan/strongManManage.vue'], r)
const EnterpriseManage = r => require(['../views/member/enterprise1/enterpriseManage'], r)
const ShopsManage = r => require(['../views/member/shops/shopsManage.vue'], r)
    // 截止
...
const PresentationDetails = r =>
    require(['../views/member/income/member_income_presentationRecord_presentationDetails'], r);
...
const routes = [
        ...
        { //新增企业分类0
            path: '/classification/enterprise',
        ...
        { //新增牛人分类 1
            path: '/classification/people',
            component: classificationPeople,
            name: 'classificationPeople',
            meta: {
                title: '牛人分类',
                foot: true
            }
        ...
        { //新增商铺分类 2
            path: '/classification/shop',
            component: classificationShop,
            name: 'classificationShop',
            meta: {
                title: '商铺分类',
                foot: true
            }
        ...
        // strongManManage 牛人管理
        {
            path: '/member/strongManManage',
        ...
        // strongManInfo
        {
            path: '/member/strongManInfo',
            component: StrongManInfo,
            name: 'strongManInfo',
            meta: {
                title: '基本信息',
                foot: true
        ...
        // strongManInfoNew
        {
            path: '/member/strongManInfoNew',
            component: StrongManInfoNew,
            name: 'strongManInfoNew',
            meta: {
                title: '基本信息',
                foot: true
            }
        ...
        // enterpriseInfoSubmitSuccess
        {
            path: '/member/enterpriseInfoSubmitSuccess',
            component: EnterpriseInfoSubmitSuccess,
            name: 'enterpriseInfoSubmitSuccess',
            meta: {
                title: '提交成功',
                foot: true
            }
        ...
        // enterpriseExamimg
        {
            path: '/member/enterpriseExamimg',
            component: EnterpriseExamimg,
            name: 'enterpriseExamimg',
            meta: {
                title: '企业管理',
                foot: true
            }
        ...
        // validFaild
        {
            path: '/member/validFaild',
            component: validFaild,
            name: 'validFaild',
            meta: {
                title: '提交成功',
                foot: true
        ...
        // validSuccess
        {
            path: '/member/validSuccess',
            component: validSuccess,
            name: 'validSuccess',
            meta: {
                title: '提交成功',
                foot: true
        ...
        // 动态发布成功
        {
            path: '/member/dynamicPubSuccess',
            component: DynamicPubSuccess,
            name: 'dynamicPubSuccess',
            meta: {
                title: '成功',
                foot: true
            }
        ...
        // promotionRecord 企业推广记录
        {
            path: '/member/promotionRecord',
        ...
        // enterpriseInfoExamFaild
        {
            path: '/member/enterpriseInfoExamFaild',
            component: EnterpriseInfoExamFaild,
            name: 'enterpriseInfoExamFaild',
            meta: {
                title: '企业管理',
                foot: true
            }
