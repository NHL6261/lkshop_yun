        ...
        <ul class="classify">
          <li class="c_child" v-for="(list, i) in dataList" :key="i">
            <ul class="c_name">
              ...
              <li class="class_b" v-show="list.id === parentID" v-for="(child, i) in list.childrens" :key="i">
                <span
              ...
              <li class="goods-info">
                <ul class="info-class">
                  ...
                  <li class="info_c">
                    ...
                    >
                    <!--<small>{{$i18n.t('money')}}</small>{{good.market_price}}/ <div class="select standard" v-show="false">-->
