  ...
  <div id="income">
    <div class="supplier">
      ...
      <div v-if="apply_status===3"
        ...
        <div class="withdraw">
          <ul class="left">
            <li><span>{{$i18n.t('money')}}</span>{{this.isDeliveryStation?distributor.finish_order_price_total:deliveryInfo.grand_total_amount}}</li>
            <li>{{this.isDeliveryStation?'销售额':'累计服务津贴'}}</li>
          </ul>
          <ul class="right">
            <li><span>{{$i18n.t('money')}}</span>{{this.isDeliveryStation?distributor.finish_withdraw_amount_total:deliveryInfo.available_total_amount}}</li>
