    ...
    <div id="content">
      ...
      <div class="goods_list">
        ...
        <ul class="goods_count">
          <li>
            <span>商品金额</span>
            <span>{{$i18n.t('money')}}{{order_goods_price}}</span>
          </li>
          <!--<li>-->
          <!--<span>运费</span>-->
          <!--<span>{{$i18n.t('money')}}20.00</span>-->
          <!--</li>-->
          <!--<li>-->
      ...
      <!--<li>-->
      <!--<span>订单金额</span>-->
      <!--<span>{{$i18n.t('money')}}3720.00</span>-->
      <!--</li>-->
      <!--<li>-->
      <!--<span>总运费</span>-->
      ...
      <div class="footer">
        <div class="price">
          ...
          <span class="price_b">{{$i18n.t('money')}}{{price}}</span>
        </div>
