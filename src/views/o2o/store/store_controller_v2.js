...
export default {
  ...
  methods: {
    ...
    getSecondCategory(category_id) {
      ...
      $http
        .post(
          "plugin.store-cashier.frontend.store.get-store-info.get-second-category",
          { store_id: this.store_id, category_id: category_id },
          "..."
        )
        .then(
          response => {
    ...
    getSecondGoods(second_category_id) {
      ...
      $http
        .post(
          ...
          { store_id: this.store_id, category_id: this.category_id, second_category_id: second_category_id || 0 },
          "..."
        )
        .then(
          response => {
    ...
    getMoreGood() {
      ...
      if (this.goodPage >= this.goodTotal_page) {
        ...
        $http.post("plugin.store-cashier.frontend.store.get-store-info.get-goods",
          {
            store_id: this.store_id,
  ...
  components: {
    cStar, cFlow, cLive, deliveryMap, cGrouplist
  },
  watch: {
    scrollMargin(newVal) {
