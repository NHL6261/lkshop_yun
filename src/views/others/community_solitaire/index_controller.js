  ...
  methods: {
    ...
    getMoreData() {
      ...
      if (this.page >= this.total_page) {
        ...
        $http.get('plugin.community-relay.frontend.activity.activity-buyer', _json, "加载中").then((response) => {
    ...
    getPoster() {
      $http.get('plugin.community-relay.frontend.activity.get-poster', { activity_id: this.$route.params.id, code_type: 1, get_type: 1 }, '')
        .then(res => {
          if (res.result == 1) {
