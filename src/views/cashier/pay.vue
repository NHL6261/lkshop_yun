    ...
    <div class="cashier" v-if="showPage">
      ...
      >
        <div class="popup">
              ...
              <div class="score" v-for="(d, i) in order_data[0].order_deductions" :key="i">
                ...
                <div class="right" v-show="isClick == 0">
                  <van-switch
                    ...
                    inactive-color="#fff"
                    size="23"
                    @change="discountHandle(order_data[0], d)"
                  />
                </div>
          ...
          <!-- 优惠券 -->
          <div
            class="tbs coupon-list"
            @click="showCoupon"
            v-if="(cashier_type == 'store' || cashier_type == 'hotel') && isShowCoupon"
          >
          ...
          <div class="tbs">
            ...
            <div class="price list" v-for="(item, index) in datas.amount_items" :key="index">
              ...
              <div class="right">
                <div class="right">
                  <font color="#E84E40"
                    ><span v-if="item.code == 'total_deduction_price'">-</span>{{ $i18n.t('money')
                    }}{{ item.amount }}</font
                  >
                </div>
              </div>
            ...
            <template v-if="price > 0">
              <div class="mod_btns" v-for="(btn, i) in payType" :key="i" v-show="btn.value != 57">
                <a @click="submit(btn)" class="mod_btn">
                  ...
                  ><span v-if="btn.value != 59">{{ btn.name }}{{ typename }}</span
