                    ...
                    if (response.result === 1) {
                        ...
                        if (!response.data.default) {
                            if (response.data.item.is_decorate === 1) {
                                ...
                                response.data.item.janst = response.data.item.page_info && response.data.item.page_info.page_title ? response.data.item.page_info.page_title : response.data.mailInfo.name;
