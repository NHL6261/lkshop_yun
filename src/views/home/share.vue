  ...
  <div id="share">
    <div class="content" :style="{ width: fun.getPhoneEnv() == 3 ? '375px' : '' }">
      <div class="ImgBg">
        ...
        <div class="poster">
          <img
            v-if="share_poster.app_share_show == 1 && is_loaded == true"
            :src="share_poster.PosterUrl"
            style="width: 100%; height: 100%; border-radius: 0.5rem;"
          />
          <img
            v-if="share_poster.app_share_show == 0 && is_loaded == true"
            src="../../assets/images/share_pic_normal@2x.png"
            alt=""
            style="width: 100%; height: 100%; border-radius: 0.5rem;"
          />
        </div>
        <div class="button">
          ...
          <van-button
            ...
            @click.native="share_btn('2')"
            v-if="share_poster.app_share_show == 1"
          >
            <img src="../../assets/images/share_posters@2x.png" class="icon"/>
            分享海报
          </van-button>
          <van-button type="default" round size="small" @click.native="siteBack()"
                      v-if="share_poster.app_share_show != 1">
            返回
          </van-button>
        </div>
    ...
    Shares(data, x) {
      ...
      if (x == 1) {
        ...
        that.sharelink =
            ...
            domain +
            "/addons/yun_shop/?#" +
            window.localStorage.getItem("share_path") +
            "?i=" +
            this.fun.getKeyByI() +
            "&type=" +
            this.fun.getTyep() +
