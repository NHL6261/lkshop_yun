          ...
          <van-pull-refresh v-model="isLoading" @refresh="loadTop" success-text="刷新成功">
            <div class="list_box">
              <div class="list" v-for="(item, index) in info" :key="index">
                <div
                  class="store-box"
                  v-if="item.has_one_store && item.has_one_store.id"
                  @click.stop="toStore(item.has_one_store.id)"
                >
                ...
                <div class="time_state">
                  ...
                  <span class="state"
                    >拼单中,还差{{
                      item.has_one_level.member_num - item.has_one_team.has_many_success_member_count
                    }}人</span
                  >
                </div>
                <div class="goods_box">
