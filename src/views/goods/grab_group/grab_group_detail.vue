  ...
  <div id="group_buy_detail">
    ...
    <div class="content">
      ...
      <div class="group_user">
        ...
        <div
          class="look_btn"
          v-if="timestamp < Number(info.team_end_time) && info.is_oneself == 1 && (info.state == 1 || info.state == 4)"
          @click="shareWeixin"
        >
        ...
        <div
          v-if="
            (timestamp < Number(info.team_end_time) && info.surplus_num != 0 && info.state == 5) ||
              info.state == 6 ||
              info.state == 3
          "
          class="look_btn"
        ...
        <div
          v-if="!isCheckActivity || timestamp > Number(info.team_end_time) || info.state == 7 || info.state == 8"
          class="look_btn"
        >
        ...
        <div
          v-if="
            info.surplus_num != 0 &&
              isCheckActivity &&
              info.is_oneself == 0 &&
              timestamp < Number(info.team_end_time) &&
        ...
        <div
          v-if="info.surplus_num != 0 && timestamp < Number(info.team_end_time) && info.state == 0"
          class="look_btn"
      ...
      <div class="win_member" v-if="!fun.isTextEmpty(info.win_member)">
        ...
        <div class="win_member_text" style="text-align: center; color: #ff2c29;">
          恭喜 {{ info.win_member.nickname }} 中奖！
        </div>
      </div>
    </div>
    <template v-if="popupSpecs">
      <yz-specs :goodsInfo="info" :popupSpecs="popupSpecs" v-on:closeSpecsPopup="close_yz_specs_popup">
