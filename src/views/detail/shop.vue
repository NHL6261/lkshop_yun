<template>
  <div class="content">
    ...
    <div class="swiper">
      ...
      >
        <van-swipe-item
          v-for="(item, index) in content.topurl"
          :key="index"
        ><img
            :src="item"
            alt=""
    ...
    <div class="contentInfo">
      ...
      >
        ...
        <div
          class="detailPic"
          v-for="(item, index) in content.texturl"
          :key="index"
        ><img
            :src="item"
            alt=""
...
export default {
  data() {
    return {
      ...
      content: {
        swipeList: [
          { url: require('../../assets/newImg/detail/shop/swipeItem.png') },
          { url: require('../../assets/newImg/detail/shop/swipeItem.png') },
          { url: require('../../assets/newImg/detail/shop/swipeItem.png') },
          { url: require('../../assets/newImg/detail/swipeItem.png') }
        ],
        logo: require('../../assets/newImg/detail/shop/logo.png'),
        title: '慈善超市',
        classification: {
          one: '一级分类',
          two: '二级分类',
  ...
  activated() {
    ...
    this.uid = this.$route.query.shopId
