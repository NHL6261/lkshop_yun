      ...
      <div class="user_message">
        <div class="user_left">
          <div class="pic" v-if="detailsData.has_one_stick_user">
            <img
              :src="detailsData.has_one_stick_user.avatar"
              alt=""
        ...
        <div class="comment_bottom">
          <ul class="maincomment">
            <li v-for="(item, index) in StickCommentData" :key="index">
              <div
                class="maincommentleft"
                @click="replyCommentsBtn(item.id, '', item.uname, item.content, item.is_own)"
              >
                <img v-if="item.has_one_comment_user" :src="item.has_one_comment_user.avatar" alt="" />
              </div>
                  ...
                  >
                    ...
                    <div class="deputy_comment_right">
                      ...
                      <div
                        class="thumb_up"
                        @click.stop="
                          praiseBtn(childitem.major_cm_id, childitem.id, index, childindex, childitem.is_praise)
                        "
                      >
                        <div class="thumb_img">
...
"
    ...
    <div class="bottom_operation set-pc-styleLeft">
      <div class="content">
        ...
        <div class="appreciate" v-if="reward_button==0" @click="moneyShow">
    ...
    <van-popup v-model="mainCommentShow" position="bottom" :overlay="true">
      <div class="replyMainComment">
        <div class="left">
          <input type="text" ref="commentInput" v-model="maincomment" placeholder="请留下你的精彩评论吧" />
        </div>
    ...
    <van-popup v-model="replyshow" position="bottom" :overlay="true">
      <div class="replyComment">
        ...
        <div class="bottom">
          ...
          <div class="replysubmit" @click="replySubmitBtn">发送</div>
        </div>
      </div>
    </van-popup>
