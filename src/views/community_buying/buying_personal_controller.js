...
export default {
  ...
  methods: {
    ...
    getData() {
      $http
        .post(
          ...
          { id: this.$route.params.id, deliver_id: this.$route.params.deliver_id },
          ""
        )
        .then(response => {
    ...
    getCar() {
      $http
        .get("plugin.package-deliver.frontend.memberCart.index", {
    ...
    getPoster() {
      $http.get("plugin.package-deliver.frontend.communityGroups.getPoster", {
        group_id: this.$route.params.id,
        code_type: 1,
        get_type: 1,
        deliver_id: this.$route.params.deliver_id
    ...
    addCart(gid, total, option_id) {
      $http
        .get("plugin.package-deliver.frontend.memberCart.store", {
          goods_id: gid,
          total: total,
          option_id: option_id,
          group_id: this.$route.params.id,
