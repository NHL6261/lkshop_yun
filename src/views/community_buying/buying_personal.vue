  ...
  <div id="buying_personal" :style="{ '--color': `${themeColor}` }">
    ...
    <div class="top-box">
      <div class="deliver" :style="{ backgroundColor: `${themeColor}` }">
        ...
        <div
          class="buyInfo"
          v-if="!fun.isTextEmpty(deliver.aptitute) || !fun.isTextEmpty(deliver.thumb)"
              ...
              >
                <transition name="slide-fadeone">
                  <i
                    ...
                    @click.stop="addCart(item.id, 1, 0)"
    ...
    <div class="container" v-if="!isBusinessInfo">
      <div class="floatBtn">
        <div
          class="my"
          :style="{ backgroundColor: `${themeColor}` }"
          :class="[alertFlag ? 'close' : '']"
          @click.stop="openAlert"
        >
          <div v-if="!alertFlag">
        ...
        <div
          :style="{ backgroundColor: `${themeColor}` }"
          @click.stop="gotoUrl('orderlist', { status: 0 })"
          class="cc"
          :class="[alertFlag ? 'c1 ccs' : '']"
        >
          订单
        </div>
        <div
          ...
          class="cc"
          :class="[alertFlag ? 'c2 ccs' : '']"
        >
          分享
        </div>
        <div
          :style="{ backgroundColor: `${themeColor}` }"
          @click.stop="gotoUrl('member')"
          class="cc"
          :class="[alertFlag ? 'c3 ccs' : '']"
        >
          <div>会员</div>
          <div>中心</div>
        </div>
        <div
          :style="{ backgroundColor: `${themeColor}` }"
          v-if="deliver.isManager"
          @click.stop="gotoUrl('communityBuyIndex')"
          class="cc"
          style="padding: 0 5px;"
          :class="[alertFlag ? 'c4 ccs' : '']"
        >
          社群团购
        </div>
      </div>
