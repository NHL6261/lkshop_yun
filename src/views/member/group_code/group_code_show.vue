<template>
    <div class="page">
       <z-title :title="show_title" ></z-title>
       <div class="notice">
         <van-notice-bar
           left-icon="volume-o"
           :text="groupCodeInfo.group_code.code_guide"
         />
       </div>
       ...
       <div class="wrapper">
          ...
          <div class="opts">
              ...
              <div class="opt" v-if="groupCodeInfo.group_code.explain" @click="explainFlag = true">
        ...
        <div style="display: flex; align-items: center; justify-content: center; height: 100%;">
          <transition name="van-slide-up">
              <div class="explainWrapper" v-show="kfFlag" @click.stop>
                  ...
                  <div class="img">
                    <img :src="groupCodeInfo.group_code.customer_service_img" alt="">
                  </div>
                  <div class="kf_guide">
                    {{groupCodeInfo.group_code.customer_service_guide}}
                  </div>
              </div>
          </transition>
        </div>
        ...
        <div style="display: flex; align-items: center; justify-content: center; height: 100%;">
          <transition name="van-slide-up">
              <div class="explainWrapper" v-show="explainFlag" @click.stop>
                  ...
                  <div class="content" v-html="groupCodeInfo.group_code.explain_content"></div>
              </div>
          </transition>
        </div>
      </van-overlay>
