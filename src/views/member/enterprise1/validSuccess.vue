    ...
    <div class="supplier">
      ...
      <div class="main">
        ...
        <div class="welcome">
          ...
          <p class="success-text">认证成功</p>

          <van-button type="info" block style="margin-bottom: 49px" @click="handleToBaseInfo"
            >继续补充基本信息</van-button
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleToBaseInfo() {
      ...
      if (this.$route.params.tag == 'strongMan') {
        // 牛人
        this.$router.push(this.fun.getUrl('strongManInfo'))
      } else if (this.$route.params.tag == 'enterprise') {
        // 企业
        this.$router.push(this.fun.getUrl('enterpriseInfo'))
      } else if (this.$route.params.tag == 'shops') {
        // 商铺
