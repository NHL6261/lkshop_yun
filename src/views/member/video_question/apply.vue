  ...
  <div id="apply">
      ...
      <div class="conrt">
        <template v-if="application_audit_status == 2">
          ...
          <div class="agreement">
            ...
            我已详细阅读并同意《 <span @click="is_agreement = true">服务协议</span>》
          </div>
          <div class="agreement" style="margin-top: 1rem;">
            若您的手机号未注册，将为你自动注册，注册或登录即代表您同 意我们的
            <span @click="is_agreement = true">《服务协议》</span>
          </div>
    ...
    <van-popup v-model="is_agreement">
      <div class="pop_agreement">
        <div style="margin-bottom: 1.19rem;">服务协议</div>
    ...
    <van-popup v-model="submit_status">
      <div class="success">
        ...
        <div style="margin-bottom: 2rem; font-size: 0.75rem;">等待平台审核！</div>
