<template>
  <div id="goodslist">
    ...
    <div class="store">
          ...
          <div class="store-intro2">
            ...
            <div class="discount-box">
              ...
              >
                ...
                <span style="margin-left: 0.5rem;" v-if="items.store_point.point_deduct_switch == 0 ? false : true">{{
              ...
              <p class="discount-item" v-if="items.store_full_reduction && items.store_full_reduction.length != 0">
                ...
                <span
                  style="margin-left: 0.5rem;"
                  v-for="(reduction, index) in items.store_full_reduction"
                  :key="index"
                  v-if="index <= 2"
                  >{{ reduction }}</span
                >
      ...
      <div style="width: 100%; height: 50px; line-height: 50px;" v-if="!show">{{ $i18n.t('没有更多了') }}~</div>
      <div style="width: 100%; height: 50px; line-height: 50px;" v-if="show" @click="getMoreStores">
        {{ $i18n.t('加载更多') }}
      </div>
    </div>
  </div>
