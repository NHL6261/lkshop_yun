    ...
    >
      ...
      >
        <div class="store_box">
              ...
              <div class="store-intro2">
                ...
                <div class="score-box">
                  <div class="score-left">
                    <i class="iconfont icon-card_collect_b"></i><span>{{ items.average_score }}分</span
                    ><span style="margin-left: 0.5rem;">月售{{ items.order_total }}单</span>
                  </div>
                  <div class="score-right" @click.stop="goToAdress(items)" v-if="items.distance">
                ...
                <div class="discount-box">
                  ...
                  <p class="discount-item" v-if="items.store_point.point_switch != 0 || items.store_love.award == 1">
                    ...
                    <span style="margin-left: 0.5rem;" v-if="items.store_point.point_switch == 0 ? false : true">{{
                      items.store_point.point
                    }}</span>
                    <span style="margin-left: 0.5rem;" v-if="items.store_love.award == 1 ? true : false">{{
                      items.store_love.award_proportion
                    }}</span>
                  </p>
                  <p
                    class="discount-item"
                    v-if="items.store_point.point_deduct_switch != 0 || items.store_love.deduction == 1"
                  >
                    <span class="red">抵扣</span>
                    <span style="margin-left: 0.5rem;" v-if="items.store_love.deduction == 1 ? true : false">{{
          ...
          <div v-if="shopList0.length <= 0" style="width: 100%; height: 50px; line-height: 50px;">
            {{ $i18n.t('没有更多了') }}~
          </div>
      ...
      >
        <div class="rebate_box">
            ...
            <div class="tab_b">
              <ul class="tab_b_box">
                <li
                  ...
                  @click="pdClassfySearch(index, classfy.id)"
                  :key="index"
                >
                  {{ classfy.name }}
                </li>
          ...
          <div v-if="shopList1.length <= 0" style="width: 100%; height: 50px; line-height: 50px;">
            {{ $i18n.t('没有更多了') }}~
          </div>
      ...
      >
        <div class="coupon_list">
              ...
              <div class="coupon" v-for="(item, i) in shopList2" :key="i">
                <div class="left">
                  <div class="img">
                    <img
                      :src="
                        item.store && item.store.thumb ? item.store.thumb : require('../../assets/images/photo-mr.jpg')
                      "
          ...
          <div v-if="shopList2.length <= 0" style="width: 100%; height: 50px; line-height: 50px;">
            {{ $i18n.t('没有更多了') }}~
          </div>
      ...
      >
        <div class="gift_box">
          ...
          <div v-if="shopList3.length <= 0" style="width: 100%; height: 50px; line-height: 50px;">
            {{ $i18n.t('没有更多了') }}~
          </div>
