  ...
  <div :class="className">
    ...
    <div class="html-box" v-if="(datas.show_list && datas.show_list.length > 0) || datas.list.length > 0">
      <div id="membermerchant">
        ...
        <!-- 无身份 -->
        <ul class="tool-boxlis" v-if="member_item.typea === 0">
          <li v-for="icon in applyList" :key="icon.url" @click="pluginGoto(icon)">
            <div class="lis">
        ...
        <!-- <template v-if="member_item.typea === 0" class="tool-boxlis">
          <div class="list1" v-for="item in applyList" :key="item.url" @click="pluginGoto(item)">
        ...
        <template v-else>
          ...
          <ul class="tool-boxlis" v-if="member_item.typea === 1">
            <li v-for="item in enterpriseList" :key="item.url" @click="pluginGoto(item)">
              <div class="lis">
          ...
          <!-- <div class="list1" v-if="member_item.typea === 1" v-for="item in enterpriseList" :key="item.url" @click="pluginGoto(item)">
            <i class="more-icon" :class="item.icon"></i>
            <span slot="text">{{ item.title }}</span>
            <i class="fa fa-angle-right"></i>
          </div> -->
          ...
          <ul class="tool-boxlis" v-if="member_item.typea === 2">
            <li v-for="item in shopsList" :key="item.url" @click="pluginGoto(item)">
              <div class="lis">
          ...
          <!-- 2商铺管理
          <div class="list1" v-if="member_item.typea === 2" v-for="item in shopsList" :key="item.url" @click="pluginGoto(item)">
            <i class="more-icon" :class="item.icon"></i>
            <span slot="text">{{ item.title }}</span>
            <i class="fa fa-angle-right"></i>
          </div> -->
          ...
          <ul class="tool-boxlis" v-if="member_item.typea === 3">
            <li v-for="item in strongManList" :key="item.url" @click="pluginGoto(item)">
              <div class="lis">
                <i class="iconfont" :class="item.icon" style="font-size: 25px"></i>
                <div>{{ item.title }}</div>
              </div>
  ...
  methods: {
    ...
    pluginGoto(item) {
      if (item.name == "article") {
        ...
        this.$router.push("member/strongManInfoNew?i=2&type=5&mid=0&shop_id=1");
