            ...
            >
              <van-tab title="商家" name="business_merchant" v-if="datas.tab_list.indexOf('1') > -1">
                <div class="store-box">
                    ...
                    <div class="item-top">
                      ...
                      <div class="right">
                        ...
                        <div class="sale">
                          ...
                          <div class="num" v-if="datas.discount_list.indexOf('1') > -1">
                            月销{{ items.order_total }}单
                          </div>
                          <div class="num" v-if="datas.discount_list.indexOf('1') < 0"></div>
                          <div class="distance" @click.stop="goToAdress(items)" v-if="items.distance">
                        ...
                        <div class="discounts">
                          <div
                            ...
                            v-if="
                              datas.discount_list.indexOf('4') > -1 &&
                                items.has_many_coupon &&
                                items.has_many_coupon.length > 0
                            "
                          >
                          ...
                          <div
                            class="discounts-list"
                            v-if="
                              (datas.discount_list.indexOf('3') > -1 && items.store_point.point_deduct_switch != 0) ||
                                items.store_love.deduction == 1
                            "
                          >
                          ...
                          <div
                            class="discounts-list"
                            v-if="
                              (datas.discount_list.indexOf('2') > -1 && items.store_point.point_switch != 0) ||
                                items.store_love.award == 1
                            "
                          >
                    ...
                    >
                      <div class="goods-list">
                        ...
                        >
                          ...
                          <div class="price" v-if="fun.isTextEmpty(good.goods_show)">
                  ...
                  <div v-if="(shopList0.length <= 0 || !isLoadMore0) && lastIndex == index" class="loading-box">
                    {{ $i18n.t('没有更多了') }}~
                  </div>
                        ...
                        <div>
                          ...
                          <div class="p2">
                            <span v-show="parseInt(item.market_price)"
                              >{{ $i18n.t('money') }}{{ item.market_price }}</span
                            >
                          </div>
                          <!--<div class="p3">-->
                          <!--会员价：100.00-->
            ...
            if (response.result === 1) {
              ...
              if (this.tab == 0) {
                if (this[`shopList${this.tab}`].length > this.datas.get_number) {
                  this[`shopList${this.tab}`].splice(
                    this.datas.get_number,
                    this[`shopList${this.tab}`].length - this.datas.get_number
                  );
                  this[`isLoadMore${this.tab}`] = false;
                }
              }
