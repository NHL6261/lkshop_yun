        ...
        <div style="-webkit-overflow-scrolling: touch; min-height: 101vh;" id="main">
          ...
          <div class="act-box">
            ...
            <ul class="fee">
              ...
              <li style="margin-left: 0.5rem; color: #000;">
                <span
                  ><a :href="'tel:' + hotel_info.hotel_mobile" style="color: #000;"
                    >联系{{ PageNameList.hotels }}:{{ hotel_info.hotel_mobile }}</a
                  ></span
                >
              </li>
            </ul>
                      ...
                      <div class="box" v-for="item in goods_info.show_push" :key="item.id" @click="pushGoodGoto(item)">
                        ...
                        <ul class="goods-info">
                          ...
                          <li class="pay">
                            <div
                              class="left left1"
                              v-if="goods_info.vip_level_status && goods_info.vip_level_status.status == 1"
                            >
