        ...
        <div style="-webkit-overflow-scrolling: touch; min-height: 101vh;" id="main">
          ...
          <div class="member-box" v-if="prdocut_market.plugin && prdocut_market.plugin.length > 0" @click="PopupShow = true">
            <span class="optiondiv">
              应用 <em style="padding-left: 0.625rem; color: #333;">{{ prdocut_market.apps }}</em>
            </span>
            <span><em class="application">插件</em></span>
          </div>
          <div class="act-box">
...
"
      ...
      <div id="foot">
        ...
        <div v-if="isCup && goods_info.get_goods && goods_info.get_goods.plugin_id != 72" class="addfav">
      ...
      <van-popup class="poster-popup-class" v-model="posterShow" round><yz-goodsposter :posterData="posterImg" :goodstype="true"></yz-goodsposter> </van-popup>
      <van-popup v-model="PopupShow" closeable position="bottom">
        ...
        <div class="popup-box" v-if="prdocut_market.plugin && prdocut_market.plugin.length > 0">
          <p class="popup-item van-hairline--bottom" v-for="(item, index) in prdocut_market.plugin" :key="index">
            {{ item }}
          </p>
        </div>
      </van-popup>
