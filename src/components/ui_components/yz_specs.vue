<template>
  <div id="yz_specs">
    <van-popup
      v-model="popupSpecs"
      position="bottom"
      class="mint-popup-4 pcStyle_mint set-pc-styleLeft"
      closeable
      @close="close_yz_specs_popup(0)"
      round
      :close-on-click-overlay="false"
    >
      <div class="specifications">
        <!-- <div class="icon_close" @click.stop="close_yz_specs_popup">
        ...
        <div v-if="!isRent">
          <van-row>
            ...
            <van-stepper
              ...
              integer
              :disabled="
                $route.name == 'grab_group' || $route.name == 'grabGroup_detail' || optionsMaxCount == 0 ? true : false
              "
            />
          </van-row>
        </div>
        <van-button
          ...
          id="btsmall"
          v-show="popStock >= 1"
          @click.stop="close_yz_specs_popup(1)"
        >
          确认
        </van-button>
